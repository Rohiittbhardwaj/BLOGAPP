...
import { assets, footer_data } from '../assets/QuickBlog-Assets/QuickBlog-Assets/assets'
    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/10'>
        <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500'>
          <div>
            ...
            <p className='max-w-[410px] mt-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed, reprehenderit.</p>
          </div>
